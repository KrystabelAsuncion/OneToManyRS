...
<body>
    <div class="container d-flex justify-content-center">
        <div class="card p-4">
            <h1 class="mx-auto">Edit Student</h1>
            <form action="{{ route('students.update',$student->id) }}" method="POST" class="mx-auto" style="width: 500px;">
                @csrf
                @method('PUT')
                <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            $("#add-subject").click(function() {
                ...
                var html = `
                    <div class="subject-field">
                        <label for="subject_${index}">Subject ${index + 1}</label>
